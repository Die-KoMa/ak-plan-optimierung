...
possible_time_constraints = ["ResoAK", "Dienstag", "Mittwoch", "Donnerstag", "Freitag"]
...
for num_time_slots in num_time_slots_collection:
    ...
    for time_slot_number in range(num_time_slots):
        ...
        time_slot = {
            ...
            "info" : {
                "start" : possible_time_constraints[index] + ", " + str(8 + time_slot_number) + "Uhr"
            },
